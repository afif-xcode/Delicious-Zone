    ...
    <div className="rounded-md border-[1px] border-shadowColor bg-white p-6">
      ...
      <div>
        ...
        <ul className="items-center w-full text-sm font-medium my-10 text-black bg-shadowColor bg-opacity-30 border border-primaryColor rounded-lg sm:flex">
          <li onClick={()=> setPaymentMod("COD")} className="w-full border-b border-primaryColor sm:border-b-0 sm:border-r">
          ...
          <li onClick={()=> setPaymentMod("Online")}  className="w-full border-b border-primaryColor sm:border-b-0">
            <div className="flex items-center pl-3">
        ...
        <div className="ml-auto flex max-w-max items-center gap-x-4">
          ...
          <IconBtn disabled={loading} text="Place Order" onclick={handleOrderPlace}/>
        </div>
      </div>
    </div>
  )
